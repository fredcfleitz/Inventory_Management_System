...
public class ModifyProductController implements Initializable {
    ...
    public void modifyProductButton(ActionEvent event) throws IOException{
        ...
        if (Integer.parseInt(maxField.getText()) >= Integer.parseInt(minField.getText())){
            ...
            Product modProduct = new Product(Integer.parseInt(idField.getText()),nameField.getText(),Double.parseDouble(priceField.getText()),Integer.parseInt(stockField.getText()),Integer.parseInt(minField.getText()),Integer.parseInt(maxField.getText()));
            for(Part p:associatedPartsList){
                modProduct.addAssociatedPart(p);
            }
            Inventory.updateProduct(Inventory.selectedIndex,modProduct);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        idField.setText(Integer.toString(Inventory.selectedProduct.getId()));
        nameField.setText(Inventory.selectedProduct.getName());
        stockField.setText(Integer.toString(Inventory.selectedProduct.getStock()));
        priceField.setText(Double.toString(Inventory.selectedProduct.getPrice()));
        ...
        associatedPartsList = Inventory.selectedProduct.getAllAssociatedParts();
        associatedPartsTable.setItems(associatedPartsList);
    }    
